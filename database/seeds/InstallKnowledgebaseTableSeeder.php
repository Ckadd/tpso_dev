...
class InstallKnowledgebaseTableSeeder extends Seeder
{
    /**
    ...
    {
        return DB::table('data_types')->where('slug', 'knowledgebases')
        ->count();
    }
    ...
    public function insertToDataTypes()
    {
        return DB::table('data_types')->insertGetId([
            'name' => 'knowledgebases',
            'slug' => 'knowledgebases',
            'display_name_singular' => 'Knowledgebase',
            'display_name_plural' => 'Knowledgebases',
            'icon' => 'voyager-book',
            'model_name' => 'App\Model\Knowledgebase',
            'policy_name' => null,
    ...
    public function insertToDataRows($dataTypeId)
    {
        $rows = [
            ...
            [
                'field' => 'knowledgebase_hasmany_knowledgebase_view_relationship',
                'data_type_id' => $dataTypeId,
                'type' => 'relationship',
                'display_name' => 'knowledgebase_views',
                'required' => 0,
                'browse' => 0,
                'read' => 1,
                'edit' => 0,
                'add' => 0,
                'delete' => 0,
                'details' => '{"model":"App\\\\Model\\\\KnowledgebaseView","table":"knowledgebase_views","type":"hasMany","column":"knowledgebase_id","key":"id","label":"id","pivot_table":"categories","pivot":"0","taggable":"0"}',
                'order' => 12
            ],
        ];
    ...
    {
        $keys = ['browse_knowledgebases', 'read_knowledgebases', 'edit_knowledgebases', 'add_knowledgebases', 'delete_knowledgebases'];
    ...
    public function insertMenuItems()
    {
        ...
        $checkMenuContent = DB::table('menu_items')->select('id')->where('title','Knowledgebase')->get()->toArray();
        ...
        DB::table('menu_items')->insert([
            [
                ...
                'created_at' => now(),
                'updated_at' => now(),
                'route' => 'voyager.knowledgebases.index',
                'parameters' => null
            ]
        ]);
    }
