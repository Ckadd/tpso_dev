...
class InstallTourStandardTableSeeder extends Seeder
{
    /**
    ...
    {
        return DB::table('data_types')->where('slug', 'tour-standards')
            ->count();
    }
    ...
    public function insertToDataTypes()
    {
        return DB::table('data_types')->insertGetId([
            'name' => 'tour_standards',
            'slug' => 'tour-standards',
            'display_name_singular' => 'Tour Standard',
            'display_name_plural' => 'Tour Standards',
            'icon' => 'voyager-book',
            'model_name' => 'App\Model\TourStandard',
            'policy_name' => null,
            'controller' => 'TourStandardController',
            'description' => null,
    ...
    public function insertToDataRows($dataTypeId)
    {
        $rows = [
            ...
            [
                'field' => 'tour_standard_hasmany_tour_standard_view_relationship',
                'data_type_id' => $dataTypeId,
                'type' => 'relationship',
                'display_name' => 'tour_standard_views',
                'required' => 0,
                'browse' => 0,
                'read' => 1,
                'edit' => 0,
                'add' => 0,
                'delete' => 0,
                'details' => '{"model":"App\\\\Model\\\\TourStandardView","table":"tour_standard_views","type":"hasMany","column":"tour_standard_id","key":"id","label":"id","pivot_table":"annual_budget_views","pivot":"0","taggable":"0"}',
                'order' => 12
            ],
        ];
    ...
    {
        $keys = ['browse_tour_standards', 'read_tour_standards', 'edit_tour_standards', 'add_tour_standards', 'delete_tour_standards'];

        foreach ($keys as $key) {
            $permission = [
                'key' => $key,
                'table_name' => 'tour_standards',
                'created_at' => now(),
                'updated_at' => now()
            ];
    ...
    public function insertMenuItems()
    {
        ...
        $checkMenuContent = DB::table('menu_items')->select('id')->where('title','TourStandard')->get()->toArray();
        ...
        DB::table('menu_items')->insert([
            [
                ...
                'created_at' => now(),
                'updated_at' => now(),
                'route' => 'voyager.tour-standards.index',
                'parameters' => null
            ]
        ]);
    }
