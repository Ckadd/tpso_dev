                            ...
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endforeach
                                        <td><a href="{{route('job.detail',['id' => $data->id])}}" class="btn btn-default" target="_blank">PreView</a></td>
                                        <td class="no-sort no-click" id="bread-actions">
                                        @if($data->name == "HomePage")
                                            @php 
                                                $actionsHomepage = ['TCG\Voyager\Actions\EditAction','TCG\Voyager\Actions\ViewAction']; 
                                            @endphp
                                            @foreach($actionsHomepage as $action)                                            
