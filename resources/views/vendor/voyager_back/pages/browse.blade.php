                            ...
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endforeach
                                        <td><a href="{{route('pages.data',['id'=>$data['id']])}}" class="btn btn-default" target="_blank">Preview</a></td>
                                        <td class="no-sort no-click" id="bread-actions">
                                        @if($data->slug == "thank-you-pages" || $data->excerpt == "Thank you Pages" || $data->slug == "thank-you-mail" || $data->slug == "intro-pages")
                                            @php 
                                                $actionsThankYou = ["TCG\Voyager\Actions\EditAction","TCG\Voyager\Actions\ViewAction"]; 
                                            @endphp
                                            
                                            @foreach($actionsThankYou as $action)
