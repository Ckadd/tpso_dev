            ...
            <div class="col-xs-12">
                <div class="panel panel-bordered">
                    <div class="panel-heading">
                        <h3 class="panel-title panel-icon"><i class="voyager-window-list"></i>{{ __('voyager::generic.faqs_in_faqcategories') }}</h3>
                    </div>
                    <div class="panel-body">
                        <table id="dataTable" class="table table-hover">
                            ...
                            <tbody>
                                @foreach (FaqcategoryService::findFaqInFaqcategory($dataTypeContent->id)['faqs'] as $key => $menuFaq)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ $menuFaq['title'] }}</td>
                                    <td id="bread-actions" style="">
                                        <a class="btn btn-sm btn-primary pull-right edit" href="{{ route('voyager.faqs.edit', ['id' => $menuFaq['id']]) }}">
                                            <i class="voyager-edit"></i>
                                            <span class="hidden-xs hidden-sm">{{ __('voyager::generic.edit') }}</span>
                                        </a>
                                        <a class="btn btn-sm btn-warning pull-right view" style="margin-left: 5px;" href="{{ route('voyager.faqs.show', ['id' => $menuFaq['id']]) }}">
                                            <i class="voyager-edit"></i>
