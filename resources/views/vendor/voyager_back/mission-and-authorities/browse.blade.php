                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            @if(!empty($data->id))
                                                @php $buttonAction = ["TCG\Voyager\Actions\DeleteAction","TCG\Voyager\Actions\EditAction","TCG\Voyager\Actions\ViewAction"]; @endphp
                                                @foreach($buttonAction as $action)
