...
@section('javascript')
    <script>
        ...
        $('document').ready(function () {
            ...
            $('.select2-selectall').on('change', function() {

                var organizationSelect = $('.select2').find('option')

                if ($(this).prop('checked')) {

                    organizationSelect.prop('selected', 'selected').end().select2()
                } else {

                    organizationSelect.prop('selected', '').end().select2()
                }
            })
        });
    </script>
