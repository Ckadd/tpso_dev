...
@section('content')
    <div class="page-content read container-fluid">
        ...
        <!-- Begin show user in organizaztion -->
        <div class="row">
            <div class="col-xs-12">
                <div class="panel panel-bordered">
                    <div class="panel-heading">
                        <h3 class="panel-title panel-icon"><i class="voyager-window-list"></i>{{ __('voyager::generic.user_in_organization') }}</h3>
                    </div>
                    <div class="panel-body">
                        <table id="dataTable" class="table table-hover">
                            <thead>
                                <tr>
                                    <th style="width: 10%">{{ __('voyager::profile.avatar') }}</th>
                            ...
                            <tbody>
                                @foreach (OrganizationService::findUserInOrganization($dataTypeContent->id)['users'] as $user)
                                <tr>
                                    <td>
                                        <img style="width: 60px;" src="{{ url('storage/' . $user['avatar']) }}" alt=""></td>
                                    <td>{{ $user['name'] }}</td>
                                    <td>{{ $user['email'] }}</td>
                                    <td id="bread-actions" style="">
                                        <a class="btn btn-sm btn-primary pull-right edit" href="{{ route('voyager.users.edit', ['id' => $user['id']]) }}">
                                            <i class="voyager-edit"></i>
                                            <span class="hidden-xs hidden-sm">{{ __('voyager::generic.edit') }}</span>
                                        </a>
                                        <a class="btn btn-sm btn-warning pull-right view" style="margin-left: 5px;" href="{{ route('voyager.users.show', ['id' => $user['id']]) }}">
                                            <i class="voyager-edit"></i>
        ...
        <!-- End show user in organizaztion -->
