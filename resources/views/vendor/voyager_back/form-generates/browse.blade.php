                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-success text-center btn-excel" data-url="{{ route('form.generate.export',['id'=>$data->id]) }}">Download</button>
                                        </td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                ...
                <div class="container">
                    ...
                    <p style="color:#ff4d4d">*กรณีไม่เลือกวัน จะดึงข้อมูลออกมาทั้งหมด</p>
                </div>
