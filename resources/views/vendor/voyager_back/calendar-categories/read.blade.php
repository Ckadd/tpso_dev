...
@section('content')
    <div class="page-content read container-fluid">
        ...
        <!-- Begin show faqs in faqCategories -->
        <div class="row">
            <div class="col-xs-12">
                <div class="panel panel-bordered">
                    <div class="panel-heading">
                        <h3 class="panel-title panel-icon"><i class="voyager-window-list"></i>{{ __('voyager::generic.calendardetail_in_calendar') }}</h3>
                    </div>
                        ...
                        <table id="dataTable" class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('voyager::generic.image') }}</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>

                                @foreach (CalendarcategoryService::findCalendarDetail($dataTypeContent->id)[0]['calendar_detail'] as $key => $menuDetail)
                                <tr>
                                    <td>{{ $key + 1 }}</td>
                                    <td>{{ $menuDetail['title'] }}</td>
                                    <td>
                                    <img style="height:100px;" class="img-responsive" src="{{ filter_var($dataTypeContent->{$row->field}, FILTER_VALIDATE_URL) ? $dataTypeContent->{$row->field} : Voyager::image($menuDetail['cover_image']) }}">
                                    </td>
                                    <td id="bread-actions" style="">
                                        <a class="btn btn-sm btn-primary pull-right edit" href="{{ route('voyager.calendar-details.edit', ['id' => $menuDetail['id']]) }}">
                                            <i class="voyager-edit"></i>
                                            <span class="hidden-xs hidden-sm">{{ __('voyager::generic.edit') }}</span>
                                        </a>
                                        <a class="btn btn-sm btn-warning pull-right view" style="margin-left: 5px;" href="{{ route('voyager.calendar-details.show', ['id' => $menuDetail['id']]) }}">
                                            <i class="voyager-edit"></i>
