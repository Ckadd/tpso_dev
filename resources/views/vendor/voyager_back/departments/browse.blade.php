                            ...
                            <table id="dataTable" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        @endforeach
                                        <th>{{ __('voyager::generic.department_menu')}}</th>
                                        <th class="actions text-right">{{ __('voyager::generic.actions') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($dataTypeContent as $data)
                                    @if($data->slug == "template")
                                    ...
                                    <tr>
                                        ...
                                        @endforeach
                                        <td>
                                        <a href="{{ route('voyager.department-menus.create') }}?check={{ base64_encode('mainmenu')}}&idsubMenu=&title={{$data->title}}&idtitle={{$data->id}}" class="btn btn-success btn-sm">
                                            <i class="voyager-plus"></i> <span>{{ __('voyager::generic.department_addmenu') }}</span>
                                        </a>
                                        </td>
