                            ...
                            <table id="dataTable" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        @endforeach
                                        <th>{{ __('voyager::generic.department_addsubmenu') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @endforeach
                                        <td>
                                        @if(empty($data->parrent_id))
                                        <a href="{{ route('voyager.department-menus.create') }}?idsubMenu={{$data->id}}&check={{ base64_encode('submenu')}}&title={{$data->title}}&idtitle={{$data->department_id}}" class="btn btn-success btn-sm">
                                            <i class="voyager-plus"></i> <span>{{ __('voyager::generic.department_addsubmenu') }}</span>
                                        </a>
                                        @endif
                                        </td>
                                        <td class="no-sort no-click" id="bread-actions">
                                            @foreach(Voyager::actions() as $action)
                                                ...
                                                @if($action == 'TCG\Voyager\Actions\EditAction')
                                                    <a href="{{ route('admin.department',['id'=>$data['id']]) }}?title={{$data->title}}&idtitle={{$data->department_id}}" title="Edit" class="btn btn-sm btn-primary pull-right edit">
