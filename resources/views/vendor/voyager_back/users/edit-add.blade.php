                ...
                <div class="col-md-8">
                    ...
                    {{-- <div class="panel"> --}}
                        ...
                        <div class="panel-body">
                            ...
                            $selectedOrganizationId = $dataTypeContent->organization_id ?? 0; 
                            
                            @endphp

                            <div class="form-group">
                                <label for="organization_id">{{ __('voyager::generic.organization') }}</label>
                                <select class="form-control select2" id="organization_id" name="organization_id">
                                    ...
                                    <option {{ $selectedOrganizationId == $organization['id'] ? 'selected' : '' }} value="{{ $organization['id'] }}">{{ $organization['name'] ?? '' }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
