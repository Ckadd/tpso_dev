                            ...
                            <table id="dataTable" class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        @if($data->status == 1)
                                        <td>
                                            <button class="btn btn-success btnconfirm" data-idcategory="{{$data->id}}" >Send Newsletter</button>
                                        </td>
                                        @else
                                        <td>
                                            <button class="btn btn-success btnconfirm" data-idcategory="{{$data->id}}" disabled>Send Newsletter</button>
                                        </td>
                                        @endif
...
<div class="modal fade" id="modal-newletter-success" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h3>ส่งข้อมูลข้าวสารเสร็จสิ้น</h3>
      </div>
      <div class="modal-footer">
