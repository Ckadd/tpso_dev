        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 toppage">
                    ...
                    ><span>{{__('menu_standard_services_for_tourism')}}</span>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 head_cshare_detail">
                            <hgroup>
                                <h2>{{__('menu_standard_services_for_tourism')}}</h2>
                                <h1>Tourism services standard</h1>
                            </hgroup>
                        </div>
                    </div>
                </div>
            ...
            @if(!empty($alldata))
                <div class="row row_viewcolumn">
                    @foreach($alldata as $key => $vv)
                        <a href="{{ route('tourism-services-standard.detail',['id' => $vv['id']]) }}" class="col-xs-12 col-sm-6 item_viewcolumn">
                            <figure>
