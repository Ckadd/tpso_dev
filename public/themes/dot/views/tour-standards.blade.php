        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 toppage">
                    ...
                    <span>{{__('menu_business_registration_standard')}}</span>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 head_cshare_detail">
                            <hgroup>
                                <h2>{{__('menu_business_registration_standard')}}</h2>
                                <h1>TOUR BUSINESS REGISTRATION STANDARD</h1>
                            </hgroup>
                        </div>
                    </div>
                </div>
            ...
            @if(!empty($alldata))
                <div class="row row_viewcolumn">
                    @foreach($alldata as $key => $vv)
                        <a href="{{ route('tour-business-registration-standard.detail',['id' => $vv['id']]) }}" class="col-xs-12 col-sm-6 item_viewcolumn">
                            <figure>
