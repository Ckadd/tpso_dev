...
<link type="text/css" rel="stylesheet" href="{{ ThemeService::path('assets/css/responsive.css') }}"/>
    ...
    <link rel="stylesheet" href="{{asset('ebook/pdfjs/viewer.css')}}"/>
    <link rel="stylesheet" href="{{asset('ebook/pdf-flip.css')}}"/>
    <style>
        .se-pre-con {
            position: fixed;
            left: 0px;
            ...
            height: 100%;
            z-index: 9999;
            background: url(ebook/pics/loader.gif) center no-repeat #fff;
        }
    </style>
</head>
...
<nav class="row mainnavbar wow fadeInDown" style="background-color:white; margin-bottom:30px;">
<!-- <div>
                    <a href="{{ route('ebooks.group',['id'=>$idReturnBack]) }}" class="btn btn-primary" style="margin: 15px 15px;">ย้อนกลับ</a>
                </div> -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-6 col-sm-4 logo"><a href="http://www.tourism.go.th/"><img src="{{ ThemeService::path('assets/images/dotlogo.png') }}"></a></div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-3 submenu_left">
                                ...
                                <h3>{{__('menu_Internal_department')}}</h3>
        ...
        <div class="findbar hidden doorHanger hiddenSmallView" id="findbar">
            ...
            <div class="splitToolbarButton">
                <button class="toolbarButton findPrevious" title="" id="findPrevious" tabindex="92"
                    ...
                    <span data-l10n-id="find_previous_label">{{__('previous')}}</span>
                </button>
                <div class="splitToolbarButtonSeparator"></div>
                <button class="toolbarButton findNext" title="" id="findNext" tabindex="93" data-l10n-id="find_next">
                    <span data-l10n-id="find_next_label">{{__('next')}}</span>
                </button>
            </div>
...
<script src="{{asset('ebook/pdfjs/compatibility.js')}}"></script>
<!-- This snippet is used in production (included from viewer.html) -->
<link rel="resource" type="application/l10n" href="{{asset('ebook/pdfjs/locale/locale.properties')}}"/>
<script src="https://code.jquery.com/jquery-2.1.4.min.js"></script>
<script src="{{asset('ebook/turnjs/turn.min.js')}}"></script>
<script src="{{asset('ebook/turnjs/zoom.min.js')}}"></script>
<script src="{{asset('ebook/pdfjs/l10n.js')}}"></script>
<script src="{{asset('ebook/pdfjs/build/pdf.js')}}"></script>
<script src="{{asset('ebook/pdfjs/debugger.js')}}"></script>
<script src="{{asset('ebook/pdfjs/viewer.js')}}"></script>
<script src="{{asset('ebook/pdf-flip.js?v=1.1.1.1.1.1')}}"></script>
