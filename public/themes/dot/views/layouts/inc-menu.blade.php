<style>
    ...
    {{-- @php echo "<pre>"; print_r($data['menu_lv3']); echo "</pre>"; exit();@endphp --}}
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-9 mainmenu">
                        ...
                        <ul>
                            ...
                            @php $cnt_class = 0; @endphp
                            @foreach ($data['parent_menu'] as $data_item)
                                @php $cnt_class = $cnt_class + 1; @endphp
                                @php $parent_id = $data_item['id']; @endphp
                                <li class="hassub<?php echo $cnt_class; ?>">
                                <a href="#">{{$data_item['title']}}</a>
                                    <div class="submenu <?php echo $cnt_class; ?>">
                                        <div class="container">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-6 submenu_mid">
                                                    <ul class="submenu_mid_list">
                                                        @foreach ($data['menu_lv2'][$parent_id] as $menu[$parent_id])
                                                                    @if(isset($data['menu_lv3'][$menu[$parent_id]['id']]))
                                                                    <li> 
                                                                        @if($menu[$parent_id]['route'])
                                                                            <a href={{route($menu[$parent_id]['route'])}}>{{$menu[$parent_id]['title']}}</a>
                                                                        @else
                                                                            <a href={{$menu[$parent_id]['url']}}>{{$menu[$parent_id]['title']}}</a>
                                                                        @endif
                                                                        <ul>
                                                                            @foreach ($data['menu_lv3'][$menu[$parent_id]['id']] as $menulv3)
                                                                                @if($menulv3['route'])
                                                                                    <li><a href={{route($menulv3['route'])}}>{{$menulv3['title']}}</a></li>
                                                                                @else
                                                                                    <li><a href={{$menulv3['url']}}>{{$menulv3['title']}}</a></li>
                                                                                @endif
                                                                            @endforeach
                                                                        </ul>
                                                                    </li>
