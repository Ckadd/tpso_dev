@extends('layouts.app')
@section('content')
{{-- @php echo "<pre>"; print_r($category); echo "</pre>"; exit(); @endphp --}}
    <section class="row">
            ...
            @foreach ($data['data'] as $data_item)
                ...
                @if($cnt == '1')
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 hilight_news_img">
                            <a href="{{ url('/news-events-detail')}}/{{$data_item['id']}}/{{$data_item['category_id']}}"><img src="{{ url('/') }}/storage/{{$img['0']}}"></a>
                        </div>
                ...
                @endif
                    <div class="col-xs-12 col-sm-4 item_news">
                        <a href="{{ url('/news-events-detail')}}/{{$data_item['id']}}/{{$data_item['category_id']}}">
