...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000004aa696bb000000004e5315cc(
...
class phpbbtemplatetwiglexer_000000004aa696bb000000004e5315cc extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5bf65b4937541520061500 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5bf65b4937924391061447 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5bf65b4937541641333887 = array(
    ...
    {
        $this->initializer5bf65b4937924391061447 && ($this->initializer5bf65b4937924391061447->__invoke($valueHolder5bf65b4937541520061500, $this, 'set_environment', array('env' => $env), $this->initializer5bf65b4937924391061447) || 1) && $this->valueHolder5bf65b4937541520061500 = $valueHolder5bf65b4937541520061500;

        return $this->valueHolder5bf65b4937541520061500->set_environment($env);
    }
    ...
    {
        $this->initializer5bf65b4937924391061447 && ($this->initializer5bf65b4937924391061447->__invoke($valueHolder5bf65b4937541520061500, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5bf65b4937924391061447) || 1) && $this->valueHolder5bf65b4937541520061500 = $valueHolder5bf65b4937541520061500;

        return $this->valueHolder5bf65b4937541520061500->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5bf65b4937924391061447 && ($this->initializer5bf65b4937924391061447->__invoke($valueHolder5bf65b4937541520061500, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5bf65b4937924391061447) || 1) && $this->valueHolder5bf65b4937541520061500 = $valueHolder5bf65b4937541520061500;

        return $this->valueHolder5bf65b4937541520061500->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5bf65b4937924391061447 = $initializer;
    }
    ...
    {
        $this->initializer5bf65b4937924391061447 && ($this->initializer5bf65b4937924391061447->__invoke($valueHolder5bf65b4937541520061500, $this, '__get', array('name' => $name), $this->initializer5bf65b4937924391061447) || 1) && $this->valueHolder5bf65b4937541520061500 = $valueHolder5bf65b4937541520061500;

        if (isset(self::$publicProperties5bf65b4937541641333887[$name])) {
            return $this->valueHolder5bf65b4937541520061500->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5bf65b4937541520061500;
    ...
    {
        $this->initializer5bf65b4937924391061447 && ($this->initializer5bf65b4937924391061447->__invoke($valueHolder5bf65b4937541520061500, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5bf65b4937924391061447) || 1) && $this->valueHolder5bf65b4937541520061500 = $valueHolder5bf65b4937541520061500;
    ...
    {
        $this->initializer5bf65b4937924391061447 && ($this->initializer5bf65b4937924391061447->__invoke($valueHolder5bf65b4937541520061500, $this, '__isset', array('name' => $name), $this->initializer5bf65b4937924391061447) || 1) && $this->valueHolder5bf65b4937541520061500 = $valueHolder5bf65b4937541520061500;
    ...
    {
        $this->initializer5bf65b4937924391061447 && ($this->initializer5bf65b4937924391061447->__invoke($valueHolder5bf65b4937541520061500, $this, '__unset', array('name' => $name), $this->initializer5bf65b4937924391061447) || 1) && $this->valueHolder5bf65b4937541520061500 = $valueHolder5bf65b4937541520061500;
    ...
    {
        $this->initializer5bf65b4937924391061447 && ($this->initializer5bf65b4937924391061447->__invoke($valueHolder5bf65b4937541520061500, $this, '__clone', array(), $this->initializer5bf65b4937924391061447) || 1) && $this->valueHolder5bf65b4937541520061500 = $valueHolder5bf65b4937541520061500;

        $this->valueHolder5bf65b4937541520061500 = clone $this->valueHolder5bf65b4937541520061500;
    }

    public function __sleep()
    {
        $this->initializer5bf65b4937924391061447 && ($this->initializer5bf65b4937924391061447->__invoke($valueHolder5bf65b4937541520061500, $this, '__sleep', array(), $this->initializer5bf65b4937924391061447) || 1) && $this->valueHolder5bf65b4937541520061500 = $valueHolder5bf65b4937541520061500;

        return array('valueHolder5bf65b4937541520061500');
    }
    ...
    {
        return $this->initializer5bf65b4937924391061447;
    }
    ...
    {
        return $this->initializer5bf65b4937924391061447 && ($this->initializer5bf65b4937924391061447->__invoke($valueHolder5bf65b4937541520061500, $this, 'initializeProxy', array(), $this->initializer5bf65b4937924391061447) || 1) && $this->valueHolder5bf65b4937541520061500 = $valueHolder5bf65b4937541520061500;
    }
    ...
    {
        return null !== $this->valueHolder5bf65b4937541520061500;
    }
    ...
    {
        return $this->valueHolder5bf65b4937541520061500;
    }
